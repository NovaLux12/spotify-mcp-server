...
154 tools. Every non-deprecated endpoint, plus extras most servers skip. [Full list →](SPEC.md)
...
| | |
|---|---|
| **Complete** | 154 tools — playback, search, catalog, library, playlists, following + extras like duplicate cleanup, M3U/CSV import-export, and podcast sessions. |
