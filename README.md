...
550 tools. Every non-deprecated endpoint, plus extras most servers skip. [Full list →](SPEC.md)
...
| | |
|---|---|
| **Complete** | 550 tools — playback, search, catalog, library, playlists, following + extras like duplicate cleanup, M3U/CSV import-export, podcast sessions, snapshot diffing, listening analytics and market checks. |
