...
600 tools. Every non-deprecated endpoint, plus extras most servers skip. [Full list →](SPEC.md)
...
| | |
|---|---|
| **Complete** | 600 tools — playback, search, catalog, library, playlists, following + extras like duplicate cleanup, M3U/CSV import-export, podcast sessions, snapshot diffing, listening analytics, market checks, stats.fm taste imports, and 11 taste composite briefs, playlists, and reports. |
