...
- Surface: 157 tools across 38 tool modules plus the top-level `verify_receipt` diagnostic + 14 fixed resource URIs + RFC-6570 templates + 10 prompts (toolsets can trim); aligned with Spotify's post-Feb-2026 API
