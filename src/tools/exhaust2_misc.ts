...
export function registerExhaust2MiscTools(_server: McpServer, _client: SpotifyClient): void {
  // Populated by the exhaust2 misc builder — do not register other slices here.
}
