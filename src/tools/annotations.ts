...
export const REGISTRAR_MANIFEST: readonly RegistrarManifestEntry[] = [
  ...
  manifestEntry('analytics', 'personalization', 'src/tools/analytics.ts', registerAnalyticsTools, [4, 2940], { readOnlySafe: true }),
  ...
  manifestEntry('swarm3analytics', 'swarm3analytics', 'src/tools/swarm3_analytics.ts', registerSwarm3AnalyticsTools, [17, 13339], { readOnlySafe: true, scopeKey: 'personalization' }),
