...
export const REGISTRAR_MANIFEST: readonly RegistrarManifestEntry[] = [
  ...
  manifestEntry('swarm3shows', 'swarm3shows', 'src/tools/swarm3_shows.ts', registerSwarm3ShowsTools, [24, 20739], { readOnlySafe: true, scopeKey: 'catalog' }),
  ...
  manifestEntry('swarm3snapshots', 'swarm3snapshots', 'src/tools/swarm3_snapshots.ts', registerSwarm3SnapshotsTools, [24, 24296], { readOnlySafe: true, scopeKey: 'playlists' }),
