...
export function registerSwarm3ShowsTools(server: McpServer, client: SpotifyClient): void {
  ...
  server.tool(
    ...
    'Remove ONE saved show from your library (DELETE /me/shows) after confirming what it is — '
  ...
  server.tool(
    'remove_saved_shows',
    'Bulk-remove shows from your library (DELETE /me/shows) after cross-checking which of the '
  ...
  server.tool(
    ...
    'Remove episodes from your library (DELETE /me/episodes) after cross-checking which are '
